...
{{-- <script type="text/javascript">
    $(document).ready(function() {
        setInterval(function() {
            $.get('/process-weapon', function(data) {
                $('#ceknilai').html(data);
            });
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('weapon', ['locale' => app()->getLocale()])}}">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('auth.data_Senjata')</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">@lang('auth.data_Senjata')<span>@lang('auth.qwe|_Hari_ini')</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">@lang('auth.status')</th>
                        <th scope="col">@lang('auth.berat')</th>
                      </tr>
                    </thead>
                    <tbody id="dataTable">
                    </tbody>
  ...
  <script>
    $.ajax({
        url: "http://localhost:8000/api/weapon-status",
        method: "GET",
